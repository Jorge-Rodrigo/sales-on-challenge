...
export class CreateAllEntities1697656627877 implements MigrationInterface {
    name = 'CreateAllEntities1697656627877'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale" ("id" SERIAL NOT NULL, "totalPrice" numeric NOT NULL, "paymentMethod" character varying(100) NOT NULL, "portion" integer NOT NULL DEFAULT '1', "installmentPrice" numeric NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "clientId" integer, CONSTRAINT "REL_1f170accf5236a71106a84ed97" UNIQUE ("clientId"), CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`);
